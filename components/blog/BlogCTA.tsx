    ...
    >
      ...
      <div className="relative max-w-[640px]">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          <Link
            href="/"
            className="inline-flex w-fit items-center justify-center rounded-full bg-[#A6FF00] px-6 py-3 text-[13px] font-bold uppercase tracking-[0.12em] !text-[#000000] transition duration-300 hover:bg-[#C7FF62] hover:!text-[#000000] focus:!text-[#000000] focus-visible:!text-[#000000] active:!text-[#000000] visited:!text-[#000000] [&_svg]:!text-[#000000]"
          >
            Jetzt IPTV kaufen
          </Link>
          <Link
            href="/#preise"
            className="inline-flex w-fit items-center justify-center rounded-full border border-[#A6FF00]/30 px-6 py-3 text-[13px] font-semibold uppercase tracking-[0.12em] text-[#A6FF00] transition duration-300 hover:border-[#A6FF00]/60 hover:text-[#C7FF62]"
          >
            Preise ansehen
          </Link>
        </div>
