      ...
      <div className="mx-auto max-w-[1360px] lg:px-12">
        <div className="mx-auto max-w-[820px] text-center">
          ...
          <p className="mx-auto mt-3 max-w-[640px] text-[14px] leading-6 text-[#E6E6E6]/88 sm:mt-4 sm:text-[15px] sm:leading-7">
            Typische Oberflächen sind Smart TV, Fire TV, Android TV, Smartphone, Tablet, PC und
            TV-Box. Welche App läuft, hängt vom Betriebssystem ab – nicht von einem Programmpaket.
          </p>
        </div>
