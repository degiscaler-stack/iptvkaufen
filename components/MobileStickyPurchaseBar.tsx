...
export default function MobileStickyPurchaseBar() {
  ...
  return (
    <div
      className="mobile-sticky-purchase-bar fixed inset-x-0 bottom-0 z-[9997] border-t border-[#A6FF00]/20 bg-[#050505]/96 px-3 py-2.5 backdrop-blur-md lg:hidden"
    ...
    >
      <div className="mx-auto flex max-w-[520px] items-center gap-2.5">
        <PricingScrollLink
          ...
          className={`${ctaSolidGreenClass} pointer-events-auto inline-flex min-h-11 flex-1 items-center justify-center rounded-full bg-[#A6FF00] px-4 text-center text-[11px] font-extrabold uppercase tracking-[0.12em] hover:bg-[#B8FF4D]`}
        ...
        <a
          ...
          className="pointer-events-auto inline-flex min-h-11 flex-1 items-center justify-center gap-2 rounded-full border border-[#25D366]/45 bg-[#0A0F0A] px-4 text-center text-[11px] font-extrabold uppercase tracking-[0.1em] text-[#F5F5F5] transition duration-300 hover:border-[#25D366] hover:text-[#25D366]"
          onClick={() => {
