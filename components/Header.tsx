    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[#1F1F1F] bg-[#050505]">
      <div className="mx-auto flex h-[88px] max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
        ...
        <div className="hidden items-center sm:flex">
          <Link
            href="#iptv-kaufen"
            className="rounded-full border border-[#A6FF00]/40 bg-[#A6FF00] px-5 py-3 text-[14px] font-extrabold leading-none uppercase tracking-[0.14em] !text-[#000000] shadow-[0_0_14px_rgba(166,255,0,0.28)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_22px_rgba(166,255,0,0.38)] [&_*]:!text-[#000000]"
          >
            Jetzt IPTV Kaufen
          </Link>
        </div>
        ...
        >
          <div className="mx-auto flex max-w-7xl flex-col gap-1">
            ...
            <Link
              href="#iptv-kaufen"
              onClick={() => setIsOpen(false)}
              className="mt-4 rounded-full bg-[#A6FF00] px-5 py-3 text-center text-[14px] font-extrabold leading-none uppercase tracking-[0.14em] !text-[#000000] shadow-[0_0_14px_rgba(166,255,0,0.28)] transition hover:shadow-[0_0_22px_rgba(166,255,0,0.38)] [&_*]:!text-[#000000]"
            >
              Jetzt IPTV Kaufen
            </Link>
          </div>
