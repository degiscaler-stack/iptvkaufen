...
type NotificationPackage = {
  ...
  packageName: "6-Monate-Paket" | "12-Monate-Paket";
  src: string;
  alt: string;
  title: string;
};
...
export default function RecentPurchaseNotification() {
  ...
  if (
    !currentPackage ||
    !(ALLOWED_DURATIONS as readonly number[]).includes(currentPackage.durationMonths)
  ) {
    return null;
  }
