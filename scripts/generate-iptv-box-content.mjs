...
const post = {
  slug: "iptv-box",
  title: "IPTV Box – Die besten Geräte für Deutschland (2026)",
  seoTitle: "IPTV Box – Die besten IPTV Geräte für Deutschland | iptvkaufenX",
  seoDescription:
    "Welche IPTV Box ist die beste? Vergleich, Einrichtung, Vorteile und Kaufberatung für Deutschland inklusive Empfehlungen.",
  description:
  ...
  image: "/images/post 3/iptv-box-1.webp",
  imageAlt: "IPTV Box mit Fernbedienung am modernen Fernseher in Deutschland",
  featured: false,
  popular: true,
  status: "published",
  relatedSlugs: ["german-iptv", "iptv-free-trial"],
  faq: [
    {
      question: "Was ist eine IPTV Box?",
      answer:
    ...
    {
      question: "Brauche ich eine IPTV Box, wenn ich einen Smart TV habe?",
      answer:
    ...
    {
      question: "Welche IPTV Box ist für Deutschland am besten geeignet?",
      answer:
    ...
    {
      question: "Wie richte ich eine IPTV Box ein?",
      answer:
    ...
    {
      question: "Wie schnell muss das Internet für eine IPTV Box sein?",
      answer:
    ...
    {
      question: "Lohnt sich eine teure IPTV Box gegenüber einem Fire TV Stick?",
      answer:
  ...
  sections: [
      ...
      blocks: [
        {
          ...
          title: "Kurz erklärt",
          items: [
            "Eine IPTV Box bringt Internet-TV per HDMI auf Ihren Fernseher – ideal für ältere TVs oder schlanke Smart-TV-Ergänzung.",
            "Android TV, Fire TV und Apple TV sind die verbreitetsten Plattformen in deutschen Haushalten.",
            "LAN-Verbindung und mindestens 16–25 Mbit/s sind die Basis für stabiles HD-Streaming.",
            "No-Name-Hardware mit vorinstallierten Gratislisten sollten Sie meiden.",
            "Hardware und IPTV-Dienst gehören zusammen – prüfen Sie Senderliste und Support vor dem Kauf.",
          ],
        },
      ],
    },
    {
      ...
      image: {
        src: "/images/post 3/iptv-box-2.webp",
        alt: "IPTV Box Setup mit HDMI am Fernseher in Deutschland",
        title: "IPTV Box – Anschluss und Einrichtung am TV",
        caption: "IPTV Box – Kompakte Hardware für Live-TV per Streaming (16:10)",
      },
    },
    {
      id: "wie-funktioniert-iptv-box",
      heading: "Wie funktioniert eine IPTV Box?",
      level: 2,
      paragraphs: [
    ...
    {
      id: "vorteile",
      heading: "Vorteile einer IPTV Box",
      level: 2,
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Einrichtung erfordert einmalig etwas Aufwand. Nicht jeder möchte Apps sideloaden oder Netzwerke konfigurieren. Wer Komfort priorisiert, wählt Anbieter mit Setup-Hilfe – etwa über [iptvkaufenX](https://iptvkaufenx.de/).",
    ...
    {
      id: "welche-iptv-box-ist-die-beste",
      heading: "Welche IPTV Box ist die beste?",
      level: 2,
      paragraphs: [
      ...
      blocks: [
        {
          ...
          caption: "IPTV Box Vergleich – typische Gerätekategorien für Deutschland",
          headers: [
            "Gerätetyp",
            "Stärken",
            "Schwächen",
          ...
          rows: [
            [
              "Android-TV-Box (Mittelklasse)",
              "Flexibel, Play Store, LAN, 4K",
              "Qualität stark modellabhängig",
              "Dauerhaftes Wohnzimmer-IPTV",
            ],
            [
              "Amazon Fire TV Stick 4K",
              "Günstig, kompakt, einfach",
              "Weniger Ports, Amazon-Ökosystem",
              "Einsteiger und Zweit-TV",
            ],
            [
              "Apple TV 4K",
              "Sehr flüssig, gute App-Qualität",
              "Höherer Preis, Apple-Welt",
              "Apple-Nutzer im Haushalt",
            ],
            [
              "No-Name-IPTV-Box",
              "Niedrigpreis",
              "Schwache Updates, unsichere Apps",
              "Nicht empfohlen",
            ],
          ],
        },
    ...
    {
      id: "android-fire-apple",
      heading: "Android TV Box vs Fire TV vs Apple TV",
      level: 2,
      paragraphs: [
      ...
      subsections: [
        {
          ...
          paragraphs: [
            ...
            "Offizielle [Android-TV-Dokumentation](https://developer.android.com/training/tv) erklärt Plattform-Grundlagen. Für den Alltag genügt meist die Anbieter-Anleitung plus eine empfohlene Player-App.",
          ],
        },
        {
          id: "fire-tv-box",
          ...
          paragraphs: [
            ...
            "Die [Fire-TV-Dokumentation](https://developer.amazon.com/docs/fire-tv/documentation.html) hilft bei technischen Fragen. In der Praxis ist der Einstieg für viele deutsche Nutzer der schnellste Weg zu einer funktionierenden IPTV Box.",
          ],
        },
        {
          id: "apple-tv-box",
    ...
    {
      id: "installation",
      heading: "Installation und Einrichtung – Schritt für Schritt",
      level: 2,
      paragraphs: [
      ...
      image: {
        src: "/images/post 3/iptv-box-3.webp",
        alt: "IPTV Box Einrichtung mit Media Player App auf dem TV",
        title: "IPTV Box – Media Player und Senderliste einrichten",
        caption: "IPTV Box – App-Setup für stabiles Live-TV (16:10)",
      },
    },
    {
      id: "internetanforderungen",
      heading: "Internetanforderungen",
      level: 2,
      paragraphs: [
        ...
        "Prüfen Sie vor dem Kauf einer teuren Box, ob Ihr Anschluss den gewünschten Komfort trägt. Ein kurzer Test mit [IPTV Free Trial](/blog/iptv-free-trial) auf dem geplanten Gerät liefert belastbare Antworten, bevor Sie in Hardware investieren.",
      ...
      blocks: [
        {
          ...
          title: "Tipp",
          paragraphs: [
            "Notieren Sie nach der Einrichtung App-Name, Version und verwendete Login-Methode. Bei Support-Anfragen sparen diese Details Zeit – besonders wenn Sie parallel einen [IPTV Free Trial](/blog/iptv-free-trial) oder ein Vollabo bei einem deutschen Anbieter nutzen.",
          ],
        },
      ],
    },
    {
      id: "kaufberatung",
      heading: "Kaufberatung für Deutschland",
      level: 2,
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Kombinieren Sie die Box mit einem seriösen IPTV-Dienst, stabiler Internetverbindung und etwas Zeit für die Ersteinrichtung. Grundlagen zu Internet-TV in Deutschland finden Sie im [German-IPTV-Artikel](/blog/german-iptv); zum risikofreien Einstieg eignet sich ein [IPTV Free Trial](/blog/iptv-free-trial).",
        "Wenn Sie bereit sind, Live-TV mit professioneller Unterstützung zu nutzen, informieren Sie sich auf [iptvkaufenX](https://iptvkaufenx.de/) über passende Pakete – und genießen Sie Ihre IPTV Box mit dem Komfort, den modernes Streaming verspricht.",
...
const outPath = join(process.cwd(), "content", "blog", "iptv-box.json");
...
const keywordCount = (text.match(/IPTV Box/gi) ?? []).length;
const density = ((keywordCount / words) * 100).toFixed(2);

console.log(`Written ${outPath}`);
console.log(`Word count: ${words}`);
console.log(`"IPTV Box" occurrences: ${keywordCount} (${density}%)`);
