...
export function assertSeoTitleLimits(): void {
  const entries: Array<[string, string]> = [
    ...
    ["ueberUns", SEO_TITLES.ueberUns],
    ["redaktionelleRichtlinien", SEO_TITLES.redaktionelleRichtlinien],
    ["inhaltsrichtlinien", SEO_TITLES.inhaltsrichtlinien],
    ["autor", SEO_TITLES.autor],
