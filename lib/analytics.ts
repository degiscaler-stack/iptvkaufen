export const ANALYTICS_EVENTS = {
  ...
  packageWhatsappClick: "package_whatsapp_click",
  trialClick: "trial_click",
  trial3EuroClick: "trial_3_euro_click",
  trialWhatsappClick: "trial_whatsapp_click",
  ...
  senderlisteGlobalSearch: "senderliste_global_search",
  senderlisteCountrySearch: "senderliste_country_search",
  senderlisteChannelResults: "senderliste_channel_results",
  senderlisteWhatsappRequest: "senderliste_whatsapp_request",
  senderlisteZeroResults: "senderliste_zero_results",
  senderlisteChannelSearch: "senderliste_channel_search",
  senderlisteCategoryOpen: "senderliste_category_open",
  senderlisteCountryOpen: "senderliste_country_open",
  senderlisteCountryClose: "senderliste_country_close",
  senderlisteShowAllChannels: "senderliste_show_all_channels",
  senderlisteShowLessChannels: "senderliste_show_less_channels",
  senderlisteCategoryFilter: "senderliste_category_filter",
  senderlisteChannelWhatsappClick: "senderliste_channel_whatsapp_click",
